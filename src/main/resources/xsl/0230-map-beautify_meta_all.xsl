<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="map/prolog" priority="5">
	    <xsl:variable name="depth" select="count(ancestor::*)"/>
	...
	<xsl:template match="map/prolog/metadata" priority="5">
	    <xsl:variable name="depth" select="count(ancestor::*)"/>
	...
	<xsl:template match="map/prolog/metadata/data" priority="5">
	    <xsl:variable name="depth" select="count(ancestor::*)"/>
...
<xsl:template match="metadata/data">
    <xsl:variable name="depth" select="count(ancestor::*)"/>
