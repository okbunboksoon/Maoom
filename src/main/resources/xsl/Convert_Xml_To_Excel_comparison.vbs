...
xmlPath  = fso.BuildPath(scriptFolder, "..\temp\Product_Equipment_List_Comparison.xml")
xlsxPath = fso.BuildPath(scriptFolder, "..\temp\Product_Equipment_List_Comparison.xlsx")
